    ...
    <div className='h-[100vh]'>
      <header className= "bg-[#2181F8] rounded-b-3xl h-[15%] w-full font-poppins">
        <div className="container mx-auto px-4 py-8 flex items-center">
          ...
          <div className="ml-auto mr-auto md:w-48 hidden sm:flex flex-col place-items-end">
            <span className="font-bold md:text-xl">8 800 332 65-66</span>
            <span className="font-semibold text-sm text-white">Support 24/7</span>
          </div>
          ...
          <nav className="contents">
            <ul className="ml-4 xl:w-48 flex items-center justify-end">
              ...
              <li className="ml-2 lg:ml-4 relative inline-block">
                <a className="" href="">
                  <div className="absolute -top-1 right-0 z-10 text-xs font-bold px-1 py-0.5 rounded-sm">3</div>
              ...
              <li className="ml-2 lg:ml-4 relative inline-block">
                <a className="" href="">
                <svg className="h-9 lg:h-16 text-white" viewBox="-20 0 190 190" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M128.36 87.1899L96.53 107L79 106L64.24 110.69L24.84 100.48L39.43 95.4799L24.89 84.6099L56.64 64.6099L71 75.0999L81.66 61.6299L123 72.6999L111.93 86.2699L128.36 87.1899ZM72 79.8599L49.35 93.8599L79.2 102L104.2 87.1499L72 79.8599ZM46.81 110.91L46.94 132.14L81.56 140.92L81.21 111.16L97.09 112.66L113.46 102.94L114.22 129.63L84.59 150L39.59 137.81L39.99 108.89L46.81 110.91Z" fill="white"/></svg>
                </a>
              </li>
              <li className="ml-2 lg:ml-4 relative inline-block">
                <a className="" href="">
                  <div className="absolute -top-1 right-0 z-10  text-xs font-bold px-1 py-0.5 rounded-sm">12</div>
